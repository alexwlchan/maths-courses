...
This example shows there is \emph{some} information in the upper triangular entries of an upper-triangular matrix, but the question is how much? We would like to always diagonalise $A$, but this example shows that it isn't always possible. Let's understand when it is possible. \datemarker{31 Oct}
...
\begin{theorem}
	[Jordan Normal Form] Every matrix is conjugate to a direct sum of Jordan blocks %
	\begin{equation*}
